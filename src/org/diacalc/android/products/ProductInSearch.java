 ...
 */
public class ProductInSearch extends ProductW{
    ...
    public ProductInSearch(String newName, float newProt, float newFat, float newCarb,
    ...
    public ProductInSearch(ProductW pr, int owner, int id){
        super(pr);
        mobile = true;
        selected = false;
        this.owner = owner;
